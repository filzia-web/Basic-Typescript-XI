...
const finalGrade: number = assignmentScore * 0.3 + midtermScore * 0.3 + finalScore * 0.3 + attendanceScore * 0.1
const participates: boolean = true;

console.log(studentName, studentID, assignmentScore, midtermScore, finalScore, attendanceScore, participates);
