...
let patientName: string = "Siti Rahma";
let criticalCondition: boolean =  false;
let hasAppointment: boolean = true;
let age: number = 67;
let hasInsurance: boolean = true;

if(criticalCondition) {
    console.log(patientName + " they are immediately assigned to the Emergency Room.");
